...
* Rename the course_style/ folder to the name of your module (eg "widget").
...
all the instances of the string "course_style" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/course_style/widget/g' {} \;

* Rename the file lang/en/course_style.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_course_style.php
...
and you should find that this course_style has been added to the list of
installed modules.
